...
class NuScenesLidarSegSCN(NuScenesLidarSegBase):
    def __init__(self,
        ...
        self.return_ori_probs = return_ori_probs
        self.return_ori_points = return_ori_points
        print('self.return_ori_probs:',self.return_ori_probs)
    ...
    def __getitem__(self, index):
        ...
        if self.pselab_data is not None:
            ...
            # out_dict['ori_pseudo_label_2d'] = self.pselab_data[index]['ori_pseudo_label_2d'][idxs]
            if self.return_ori_probs:
                out_dict['ori_probs_2d'] = self.pselab_data[index]['ori_probs_2d'][idxs]
            ...
            if self.pselab_data[index]['pseudo_label_3d'] is None:
                ...
                # out_dict['ori_pseudo_label_3d'] = self.pselab_data[index]['ori_pseudo_label_3d'][idxs]
                if self.return_ori_probs:
                    out_dict['ori_probs_3d'] = self.pselab_data[index]['ori_probs_3d'][idxs]
