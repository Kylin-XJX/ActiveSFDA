...
class MetricLogger(object):
    ...
    def __init__(self, delimiter='\t',window_size = None):
        if window_size:
            self.meters = defaultdict(lambda: AverageMeter(window_size=window_size))
            print(f"init AverageMeter with window_size = {window_size}")
        else:
